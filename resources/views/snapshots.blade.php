                                        ...
                                        <div class="rounded-xl border border-slate-200/70 bg-white p-4">
                                            <div class="flex items-start justify-between gap-3">
                                                <div>
                                                    ...
                                                    <p class="mt-2 text-2xl font-semibold text-slate-900" x-text="formatCurrency(latestSnapshot().assets)"></p>
                                                </div>
                                            ...
                                            <p class="mt-3 text-xs font-semibold uppercase tracking-[0.2em]" :class="trendClass('assets')">
                                        ...
                                        <div class="rounded-xl border border-slate-200/70 bg-white p-4">
                                            <div class="flex items-start justify-between gap-3">
                                                <div>
                                                    ...
                                                    <p class="mt-2 text-2xl font-semibold text-slate-900" x-text="formatCurrency(latestSnapshot().expenses)"></p>
                                                </div>
                                            ...
                                            <p class="mt-3 text-xs font-semibold uppercase tracking-[0.2em]" :class="trendClass('expenses')">
                                        ...
                                        <div class="rounded-xl border border-slate-200/70 bg-white p-4">
                                            <div class="flex items-start justify-between gap-3">
                                                <div>
                                                    ...
                                                    <p class="mt-2 text-2xl font-semibold text-slate-900" x-text="formatCurrency(latestSnapshot().investing)"></p>
                                                </div>
                                            ...
                                            <p class="mt-3 text-xs font-semibold uppercase tracking-[0.2em]" :class="trendClass('investing')">
                                        ...
                                        <div class="rounded-xl border border-slate-200/70 bg-white p-4">
                                            <div class="flex items-start justify-between gap-3">
                                                <div>
                                                    ...
                                                    <p class="mt-2 text-2xl font-semibold text-slate-900" x-text="formatCurrency(latestSnapshot().saving)"></p>
                                                </div>
                                            ...
                                            <p class="mt-3 text-xs font-semibold uppercase tracking-[0.2em]" :class="trendClass('saving')">
                        ...
                        <div class="rounded-lg border border-slate-200/70 bg-white p-4" x-show="snapshots.length">
                            ...
                            <div class="mt-4 flex flex-wrap gap-3 text-xs text-slate-500">
                                <template x-for="snapshot in snapshots" :key="snapshot.id">
                                    <span class="rounded-full border border-slate-200 bg-slate-50 px-3 py-1" x-text="formatDate(snapshot.captured_at)"></span>
                                </template>
                            </div>
                        </div>
