...
@section('content')
    <div class="rounded-2xl border border-slate-200/80 bg-white/90 p-8 shadow-sm">
        <div class="space-y-2">
            <p class="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Set a new password</p>
            <h1 class="text-3xl font-semibold text-slate-900 font-['Fraunces',serif]">Reset your password</h1>
